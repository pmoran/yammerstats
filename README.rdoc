...
yammerstats uses yammer4r to query a Yammer network. In fact it uses my forked version! (http://github.com/pmoran/yammer4r). You will need to follow the steps described by yammer4r to register an application and create a credentials config file.

* gem install pmoran-yammer4r
